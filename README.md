...
| 目标文档 | 需要提供的材料 | 示例请求 |
| --- | --- | --- |
| 文献综述 | 研究方向或论文题目、综述范围、参考文献要求 | `使用 $suda-thesis，根据我的研究方向“……”生成苏州大学文献综述 DOCX。` |
| 文献翻译 | 真实文章 PDF/链接/全文、目标格式要求 | `使用 $suda-thesis，把这篇真实英文文章翻译成苏州大学文献翻译 DOCX。` |
| 毕业论文正文 | 论文题目、实验/调研结果、结果图、图注、方法材料 | `使用 $suda-thesis，根据题目“……”和这些结果图生成毕业论文正文 DOCX。` |
| 任务书/中期检查 | 题目、学院专业、学生/导师字段、进度安排或完成情况 | `使用 $suda-thesis，按这些字段生成任务书和中期检查表。` |
...
```text
使用 $suda-thesis，根据我的研究方向和论文题目生成文献综述 DOCX。
使用 $suda-thesis，基于这篇真实文章生成文献翻译 DOCX。
使用 $suda-thesis，根据我的论文题目、实验结果和结果图生成毕业论文正文 DOCX。
使用 $suda-thesis 生成任务书和中期检查表。
```
